...
L["Overlay"] = true
L["The portrait overlays the Health bar (behind it) instead of sitting beside it. Combine with Colors > Transparent Health to actually see it through the bar."] = true
L["Combat Icon"] = true
